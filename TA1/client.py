...
# Create player1_label and player2_label and set them to none
...
def game():
    ...
    # Create a label with text "Player1: Joining" and store it in player1_label
    
    # Create a label with text "Player2: Joining" and store it in player2_label
