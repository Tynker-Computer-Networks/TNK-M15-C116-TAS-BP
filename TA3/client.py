    ...
    for box in boxes:
        if(box.cget("bg") == color and steps+boxes.index(box) <= len(boxes) ):
            ...
            if(steps==len(boxes)):
                ...
                updated=False
                # Create variable greet_message that store String " 'color' wins the game"
...
# Define handle_win() function that takes the message
    ...
    # Change the text of wining_message to message
